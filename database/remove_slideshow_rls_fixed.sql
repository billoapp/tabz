...
-- 2. Drop existing RLS policies (fixed syntax)
DROP POLICY IF EXISTS "Users can view slideshow images for their bar";
DROP POLICY IF EXISTS "Users can manage slideshow images for their bar";

-- 3. Create simple public access policy (like menu images)
CREATE POLICY "Slideshow images are publicly accessible" 
