-- Quick M-Pesa Fix
-- Run this in Supabase SQL Editor to diagnose and fix the sync issue
...
SELECT 
  ...
  CASE 
    WHEN b.mpesa_enabled = true OR b.payment_mpesa_enabled = true 
...
-- Step 2: Fix the sync - Update bars table to match credentials
UPDATE bars 
SET 
