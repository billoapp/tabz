...
/**
 * Enhanced Device ID System
 * - Prevents multiple tabs at same bar
 * - Allows tabs at different bars simultaneously
...
export function getDeviceId(): string {
  ...
  if (!fingerprint) {
    ...
    // Fingerprint changed - log warning but don't block
