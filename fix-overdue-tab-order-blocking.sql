...
COMMENT ON FUNCTION prevent_orders_on_overdue_tabs() IS 'Security: Prevents orders on overdue tabs with outstanding balance';
COMMENT ON TRIGGER prevent_orders_on_overdue_tabs_trigger IS 'Security: Blocks order creation for overdue tabs';
